...
public class ExpedienteTest {
	...
	// PRUEBA = NEW EXPEDIENTE(CODIGO_DOCUMENTO, NOMBRE_DOCUMENTO, FECHA_CREACION,
	// DOCUMENTO_PUBLICO, EstadoExpediente.INICIADO);
	// }
	...
	public void deberiaDevolverTrueSiTienenIgualCodigo() {
		final Documento prueba2 = new Documento(CODIGO_DOCUMENTO, null, null, null, (EstadoDocumento) null, null);
	...
	public void deberiaDevolverFalseSiNoTienenIgualCodigo() {
		final Documento prueba2 = new Documento(5, null, null, null, (EstadoDocumento) null, null);
