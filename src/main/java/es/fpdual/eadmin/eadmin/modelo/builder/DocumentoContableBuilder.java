...
public class DocumentoContableBuilder extends DocumentoBuilder {
	...
	public DocumentoContable construir() {
		return new DocumentoContable(this.codigo, this.nombre, this.fechaCreacion, this.fechaModificacion, this.estado,
				this.publico, this.importe, this.dniInteresado);
	}
