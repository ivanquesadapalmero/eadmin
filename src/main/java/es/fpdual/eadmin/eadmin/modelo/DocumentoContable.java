...
public class DocumentoContable extends Documento{
	...
	public DocumentoContable(Integer codigo, String nombre, Date fechaCreacion, Boolean publico, EstadoDocumento estado, BigDecimal importe, String dniInteresado) {
